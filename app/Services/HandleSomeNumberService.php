...
class HandleSomeNumberService {
    ...
    public function convert($number)
    {
        ...
        if(strlen($number) <= 2){
            ...
            $_number.= $this->moreThanThreeLength(substr($number,0,1),3).$this->and.$this->threewwLength(substr($number,1,3),false);
        }elseif (strlen($number) == 5) {
            $_number.= $this->moreThanThreeLength(substr($number,0,2),4).$this->and.$this->threewwLength(substr($number,2,3),false);
